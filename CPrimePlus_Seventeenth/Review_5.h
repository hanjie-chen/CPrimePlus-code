#ifndef CPRIMEPLUS_SEVENTEENTH_REVIEW_5_H
#define CPRIMEPLUS_SEVENTEENTH_REVIEW_5_H
...
bool PopStackNode(Stack * point_stack);
...
#endif //CPRIMEPLUS_SEVENTEENTH_REVIEW_5_H
